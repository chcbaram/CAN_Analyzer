...
static  __attribute__((section(".non_cache"))) uint16_t __attribute__((aligned(64))) frame_buffer[1][HW_LCD_WIDTH * HW_LCD_HEIGHT];

static  __attribute__((section(".non_cache"))) uint16_t __attribute__((aligned(64))) font_src_buffer[16 * 16];
static  __attribute__((section(".non_cache"))) uint16_t __attribute__((aligned(64))) font_dst_buffer[LCD_FONT_RESIZE_WIDTH * LCD_FONT_RESIZE_WIDTH];
